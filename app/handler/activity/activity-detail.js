...
async function detailActivity(req, res) {

    const detailActivity = await service.activityDetailSvc.activtyDetail(req)

    if (detailActivity && detailActivity.code === common.errorCode.DATA_NOT_FOUND) {
